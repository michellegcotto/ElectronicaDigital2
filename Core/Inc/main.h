...
#define LED1_J1_Pin GPIO_PIN_0
#define LED1_J1_GPIO_Port GPIOA
#define LED2_J1_Pin GPIO_PIN_1
#define LED2_J1_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define LED3_J1_Pin GPIO_PIN_4
#define LED3_J1_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define LED4_J1_Pin GPIO_PIN_0
#define LED4_J1_GPIO_Port GPIOB
#define LED3_J2_Pin GPIO_PIN_7
...
#define LED1_J2_Pin GPIO_PIN_8
#define LED1_J2_GPIO_Port GPIOA
#define LED2_J2_Pin GPIO_PIN_9
